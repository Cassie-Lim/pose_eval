...
from scripts.quantization.utils import pad_right_down_corner
from torch.autograd import Variable

def evaluate(model, val_data_dir='./val2017'):
    box_size = 368
...
# loading model
state_dict = torch.load('models/checkpoint_iter_370000.pth', map_location='cpu')['state_dict']

# create a model instance
model_fp32 = PoseEstimationWithMobileNet()
# model_fp32.load_state_dict(state_dict)
load_state(model_fp32, state_dict)
model_fp32.float()
...
# save model
torch.save(model_int8.state_dict(), "models/model_quant.pth")
